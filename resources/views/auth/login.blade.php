...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href=""><b>LSP</b>POS</a>
        </div>
        <!-- /.login-logo -->
        <div class="card">
            <div class="card-body login-card-body " style="background-color: orange;color: white">
                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="icheck-primary">
                                <input type="checkbox" style="background-color: transparent;"   id="remember">
                                <label for="remember">
                                    Remember Me
                                </label>
                            </div>
                        ...
                        <!-- /.col -->
                        <div class="col-4">
                            <button type="submit" class="btn btn-block" style="background-color: white">Sign In</button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
