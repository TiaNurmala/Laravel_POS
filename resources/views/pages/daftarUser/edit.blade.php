                ...
                <div class="card-body">
                    <form action="{{ route('daftarUser.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <center><div class="box-foto">
                                    <img src="{{ asset('assets/img/'.$user->foto) }} " alt="" id="foto"  height="230">
                                    <br>&nbsp;<br>
                                    <input type="file" name="foto" id="" class="btn btn-warning" accept="image/*" onchange="loadImage(event)"></center>
                                   
                                </div>

                                <button type="submit" class="btn btn-warning" style="float: right;">Simpan</button>
                            </div>
                        </div>
                    </form>
                </div>
