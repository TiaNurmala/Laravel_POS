                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <button type="button" class="btn-payment btn btn-sm btn-success ml-1" data-toggle="modal" data-target="#modalPayment">
                            ...
                            @else
                            <a href="{{ route('checkout.index') }}" class="btn btn-sm btn-success disabled" aria-disabled="true">Checkout</a>
                            @endif
                        </div>
                        <div class="card-footer">
                            {{--<button class="btn btn-success btn-sm" data-toggle="modal" data-target="#modalBayar">Bayar</button>--}}
                        </div>
                    </div>
                </div>
            </div>
