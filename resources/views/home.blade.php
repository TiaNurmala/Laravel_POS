...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Hai, {{ Auth::user()->nama }}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box" style="background-color: #4a3f35;">
                        <span class="info-box-icon bg-white elevation-1"><i class="fas fa-box"></i></span>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3" style="background-color: #fa7d09;">
                        <span class="info-box-icon bg-white elevation-1"><i class="fas fa-shopping-cart"></i></span>
                ...
                <!-- /.col -->
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3" style="background-color: #ff4301;">
